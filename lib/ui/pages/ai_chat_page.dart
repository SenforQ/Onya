  ...
  void initState() {
    ...
    _messages.add(
      const _ChatMessage(
        role: 'assistant',
        content:
            "Hello! I'm your music theory tutor. I can help you learn music theory, including scales, chords, intervals, rhythm, and more. What would you like to learn today?",
      ),
    );
  }
    ...
    try {
      final List<Map<String, String>> requestMessages =
        ...
        const <String, String>{
          'role': 'system',
          'content':
              'You are a friendly and patient music theory tutor. Your goal is to help students learn music theory in a clear and engaging way. Explain concepts step by step, use examples when helpful, and encourage learning. Reply in English and keep responses concise but informative.',
        },
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Ask about music theory...',
